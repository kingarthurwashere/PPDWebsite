<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="devotional_management.aspx.cs" Inherits="PPDWebsite.devotional_management" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PPA Devotional Management</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-md-12">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">Devotional Content</h4>
                                <p class="category">View and Edit the daily devotional entries</p>
