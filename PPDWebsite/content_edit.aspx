<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="content_edit.aspx.cs" Inherits="PPDWebsite.content_edit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PPA Content Edit</title>
    ...
    <script type="text/javascript">
        function successalert() {
            swal({
                title: 'Saved!',
                text: 'The content entry was updated successfully!',
                type: 'success'
            },
                function () {
                    window.location.replace("content_management.aspx");
                });
        }
    </script>
    ...
    <script type="text/javascript">
        function failedalert() {
            swal({
                title: 'Failed!',
                text: 'An error was encountered updating the content entry',
                type: 'error'
            });
        }
    </script>
                ...
                <div class="row">
                  <div class="col-md-12">
                        <div class="card ">
                            ...
                            <div class="content">
                                <div>
                                    <label>Daily development</label>
                                    <asp:TextBox ID="txtDailyDev" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>

                                    <label>Weekly development</label>
                                    <asp:TextBox ID="txtWeekly" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>

                                    <label>Prayer</label>
                                    <asp:TextBox ID="txtPrayer" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
