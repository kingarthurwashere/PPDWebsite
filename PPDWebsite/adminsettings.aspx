<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsettings.aspx.cs" Inherits="PPDWebsite.adminsettings" %>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Enter the details required below to create the user account.</p>

                  <div class="form-group">
                    <label>Name</label>                 
                    <asp:TextBox runat="server" ID="txtName" CssClass="form-control" required="required"></asp:TextBox>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <asp:TextBox runat="server" ID="txtPassword2" CssClass="form-control" required="required"></asp:TextBox>
                  </div>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                  ...
                  <asp:Button runat="server" ID="cmdSave" CssClass="btn btn-primary" Text="Save Account" OnClick="cmdSave_Click"/>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
